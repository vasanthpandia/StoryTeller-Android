...
//                Intent a = new Intent(getParent().getClass(), CreateStoryActivity.class);
                startActivity(new Intent(ContentTabs.this, CreateStoryActivity.class));
            }
        });
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_content_tabs, menu);
        return true;
    }
